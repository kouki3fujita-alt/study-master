...
| オプション期待収益・ボラティリティリスク | [Expected Option Returns](notes/03_Finance/01_Derivatives/2001_Coval_ExpectedOptionReturns.md) | Joshua D. Coval, Tyler Shumway | 2001 | コールとプットは市場betaから予測される以上に低い収益を示し、zero-beta ATMストラドルの週約−3%という損失からsystematic volatility riskの価格付けを示す |
...
- オプション期待収益、option beta、レバレッジ効果とmoneyness
- zero-betaストラドル、systematic volatility risk、crash-neutral payoff
- ストラドル収益によるボラティリティ因子と株式size anomalyの検証
